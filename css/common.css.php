...
#structureTable tbody tr th a {
    color: #000;
}

#structureTable tbody tr:hover > th a {
    color: #fff;
}
...
/* hovered items */
table tbody:first-of-type tr:not(.nopointer):hover td a,
.hover:not(.nopointer) {    
   /* color: #fff !important; */
}
...
.exportoptions #buttonGo:hover,
.importoptions #buttonGo:hover {    
    color: #fff;    
    background: #707070;
}

.exportoptions #buttonGo:active,
.importoptions #buttonGo:active {    
    color: #ccc;    
    background: #303030;
}
...
#pma_console .toolbar.collapsed:not(:hover) {
    ...
    border-<?php echo $right; ?>: solid 1px #000;
}
...
#pma_console .card {
    ...
    <?php echo $left; ?>: 100%;
    top: 0;
    border-<?php echo $left; ?>: solid 1px #000;
    z-index: 300;
